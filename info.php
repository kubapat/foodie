                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><?php echo Langs::translations[$_SESSION['lang']]["menu"]["info"]; ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12"><br>
                                ...
                                <div class="card">
                                   <div class="card-header">
                                      <h3 class="card-title"><?php echo Langs::translations[$_SESSION['lang']]["menu"]["info"]; ?></h3>
                                   </div>
                                </div>

                                <div class="card">
                                    <div class="card-body table-responsive">
                                      <?php echo Langs::translations[$_SESSION['lang']]["info"]; ?>
                                    </div>
                                </div>
